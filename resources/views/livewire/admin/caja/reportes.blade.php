                            ...
                            @foreach ($cajas as $item)
                                <div class="media pb-3 border-bottom mb-3 align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="d-flex">
                                            <a href="#" wire:click='buscarCaja({{ $item->id }})' class="fs-14 me-auto text-secondary"
                                                ><span
    ...
    @isset($cajaactiva)
        ...
        <div class="col-xl-4 col-lg-12 col-xxl-7 col-sm-12">
            <div class="card overflow-hidden">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Detalle de caja</h4><span class="badge badge-pill badge-primary">Total
                            items:
                            {{ $lista->count() }}</span>
                    </div>
                    <div class="card-body">
