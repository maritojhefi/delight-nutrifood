<div class="row">
    ...
    <x-card-col4>
        <div class="card">
            ...
            <div class="card-body">
                <select name="" id="" wire:model="sucursalSeleccionada" wire:change='buscarCaja' class="form-control">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Caja de Hoy</h4>
                        ...
                        @endswitch
                        <a href="#" wire:click="resetSucursal"><span class="badge light badge-pill badge-danger">Cambiar de sucursal</span></a>
                </div>
                <div class="card-body">
                    <div class="">
                        @empty($cajaactiva)
