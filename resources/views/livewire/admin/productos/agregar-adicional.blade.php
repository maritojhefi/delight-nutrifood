<div class="row">
               ...
               <a href="#" wire:click="seleccionado('{{$item->id}}')"> 
                <div class="media-body">
                    ...
                    <div class="d-flex">
                        ...
                        <span class="fs-14 me-auto text-secondary"><i class="fa fa-ticket me-1"></i>{{$item->adicionales->count()}}</span>
    ...
    <x-card-col4>
        <div class="card-body">
            <h4 class="card-intro-title">Lista de adicionales para {{$subcategoria->nombre}} ({{$subcategoria->adicionales->count()}})</h4>
            <ul class="index-chart-point-list">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-6">
                        ...
                        <a href="javascript:void(0);" wire:click="eliminar('{{$item->id}}')" class="btn btn-danger btn-xxs px-4">Borrar</a>
                    </div>
                </div>
    ...
    <x-card-col4>
        <div class="card-body">
            ...
            <input type="text" class="form-control" wire:model.debounce.750ms="search" placeholder="Busque adicionales">
            <ul class="index-chart-point-list">
                @foreach ($adicionales as $item)
                <a href="#"  wire:click="agregar('{{$item->id}}')"><span class="badge light badge-success m-2">{{$item->nombre}}({{$item->precio}} Bs)</span></a>
                @endforeach
