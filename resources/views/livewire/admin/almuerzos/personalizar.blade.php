            ...
            <div class="card-body">
                <div class="row mb-3 row">
                    ...
                    <div class="col-6 col-sm-6">
                        ...
                        <button class="btn btn-success" {{$imagen?'':'disabled'}} wire:click="guardarFoto">Guardar</button>
                        <div class="avatar avatar-xl position-relative mt-3 border  ">
                            
                            <img src="{{ asset('imagenes/almuerzo/'.$almuerzos[0]->foto) }}" class="w-100 border-radius-lg shadow-sm">
                           Foto actual
                        </div>
                    </div>
