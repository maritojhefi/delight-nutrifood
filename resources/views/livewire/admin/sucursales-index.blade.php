        ...
        <div class="row mb-4 align-items-center">
            <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                <a href="javascript:void(0);" class="btn btn-secondary  btn-lg btn-block rounded text-white"
                    data-bs-toggle="modal" data-bs-target="#addNewCustomer">+Nueva Sucursal</a>
                <!-- Add Order -->
                        ...
                        <div class="row m-b-30">
                            ...
                            <div class="col-md-7 col-xxl-12">
                                <div class="new-arrival-content position-relative">
                                    ...
                                    <p>Stock existente: <span
                                            class="item badge badge-xxs badge-warning light">{{ $item->productos->sum('cantidad') }}
                                            en stock <i class="fa fa-check-circle text-success"></i></span></p>
                                    <p>Ventas totales: <span
                                            class="item badge badge-xxs badge-info light">{{ $item->historial_ventas->sum('total') }}
                                            Bs</span> </p>
                            ...
                            <div class="row">
                                ...
                                <a href="javascript:void(0);" class="btn btn-danger rounded btn-sm  col-6"
                                    wire:click="eliminar('{{ $item->id }}')">Eliminar</a>
                            </div>
                        </div>
                    </div>
                </div>
