                    ...
                    <div class="">
                        <x-input-create :lista="[
                            ...
                            <x-slot name="otrosinputs">
                                <div class="mb-3 row">
                                    <select name="" class="form-control @error($categoria) is-invalid @enderror"
                                        wire:model="categoria" id="">
    ...
    <div class="col-xl-8 col-lg-12 col-xxl-7 col-sm-12">
        <div class="card overflow-hidden">
            <div class="card">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        wire:click="seleccionarSubcategoria({{ $item->id }})"
                ...
                <div class="row  mx-auto">
                    <div class="col">Mostrando {{ $subcategorias->count() }} de {{ $subcategorias->total() }}
                        registros</div>
                </div>
            </div>
