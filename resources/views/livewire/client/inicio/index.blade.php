<div>
    ...
    </div><div class="splide__slide splide__slide--clone" style="width: 418px;">
    <div class="content">
    <div class="card rounded-l shadow-xl bg-12 mb-3" data-card-height="320" style="height: 320px;">
    <div class="card-top mt-3 me-3">
    <a href="#" class="icon icon-s rounded-l shadow-xl bg-red-dark color-white float-end ms-2 me-2"><i class="fa fa-heart"></i></a>
    ...
    </div><div class="splide__slide is-active is-visible" id="single-slider-1-slide01" style="width: 418px;" aria-hidden="false" tabindex="0">
    <div class="content">
    <div class="card rounded-l shadow-xl bg-18 mb-3" data-card-height="320" style="height: 320px;">
    <div class="card-top mt-3 me-3">
    <a href="#" class="icon icon-s rounded-l shadow-xl bg-red-dark color-white float-end ms-2 me-2"><i class="fa fa-heart"></i></a>
    <a href="#" data-menu="menu-share" class="icon icon-s rounded-l shadow-xl bg-highlight color-white float-end"><i class="fa fa-shopping-cart"></i></a>
    </div>
    ...
    <div class="splide__slide" id="single-slider-1-slide02" style="width: 418px;" aria-hidden="true" tabindex="-1">
    <div class="content">
    <div class="card rounded-l shadow-xl bg-12 mb-3" data-card-height="320" style="height: 320px;">
    <div class="card-top mt-3 me-3">
    <a href="#" class="icon icon-s rounded-l shadow-xl bg-red-dark color-white float-end ms-2 me-2"><i class="fa fa-heart"></i></a>
    ...
    <div class="splide__slide" id="single-slider-1-slide03" style="width: 418px;" aria-hidden="true" tabindex="-1">
    <div class="content">
    <div class="card rounded-l shadow-xl bg-12 mb-3" data-card-height="320" style="height: 320px;">
    <div class="card-top mt-3 me-3">
    <a href="#" class="icon icon-s rounded-l shadow-xl bg-red-dark color-white float-end ms-2 me-2"><i class="fa fa-heart"></i></a>
    ...
    <div class="splide__slide splide__slide--clone" style="width: 418px;">
    <div class="content">
    <div class="card rounded-l shadow-xl bg-18 mb-3" data-card-height="320" style="height: 320px;">
    <div class="card-top mt-3 me-3">
    <a href="#" class="icon icon-s rounded-l shadow-xl bg-red-dark color-white float-end ms-2 me-2"><i class="fa fa-heart"></i></a>
    ...
    <h5 class="color-white text-center pe-2 pb-2">Sticky Mobile</h5>
    </div>
    ...
    <p class="color-green-dark mb-0 font-11">Available In stock</p>
    </div>
    </div>
    </div>
    </div><div class="splide__slide px-3 splide__slide--clone" style="width: 209px;" aria-hidden="true" tabindex="-1">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-12 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Appkit</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    </div>
    <div class="d-flex px-3">
    ...
    <p class="color-yellow-dark mb-0 font-11">Limited Stock</p>
    </div>
    </div>
    </div>
    </div><div class="splide__slide px-3 splide__slide--clone" style="width: 209px;">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-13 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">DuoDrawer</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    </div>
    <div class="d-flex px-3">
    ...
    <p class="color-red-dark mb-0 font-11">Out of Stock</p>
    </div>
    </div>
    </div>
    </div><div class="splide__slide px-3 splide__slide--clone" style="width: 209px;">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-14 rounded-m " style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">EazyMobile</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    </div>
    <div class="d-flex px-3">
    ...
    <p class="color-blue-dark mb-0 font-11">Coming Soon</p>
    </div>
    </div>
    </div>
    </div><div class="splide__slide px-3" id="double-slider-1-slide01" style="width: 209px;" aria-hidden="true" tabindex="-1">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-11 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Sticky Mobile</h5>
    ...
    <div class="splide__slide px-3" id="double-slider-1-slide02" style="width: 209px;" aria-hidden="true" tabindex="-1">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-12 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Appkit</h5>
    ...
    <div class="splide__slide px-3 is-active is-visible" id="double-slider-1-slide03" style="width: 209px;" aria-hidden="false" tabindex="0">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-13 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">DuoDrawer</h5>
    ...
    <div class="splide__slide px-3 is-visible" id="double-slider-1-slide04" style="width: 209px;" aria-hidden="false" tabindex="0">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-14 rounded-m " style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">EazyMobile</h5>
    ...
    <div class="splide__slide px-3 splide__slide--clone" style="width: 209px;">
    <div class="item bg-theme pb-3 shadow-l rounded-m">
    <div data-card-height="200" class="card mb-3 bg-11 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Sticky Mobile</h5>
    ...
    <h5 class="color-black float-start font-13 font-500 line-height-s pb-3 mb-3">Global<br>Shipping</h5>
    </div>
    ...
    <h5 class="color-black float-start font-13 font-500 line-height-s pb-3 mb-3">24/7<br>Support</h5>
    </div>
    <div class="col-6">
    ...
    <h5 class="color-black float-start font-13 font-500 line-height-s">5.0<br>Rating</h5>
    </div>
    <div class="col-6 ps-0">
    ...
    <h5 class="color-black float-start font-13 font-500 line-height-s">Free<br>Returns</h5>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="divider divider-margins mt-4"></div>
    <div class="content mb-3">
    <h5 class="float-start font-16 font-500">Based on Your Favorites</h5>
    <a class="float-end font-12 color-highlight mt-n1" href="#">View All</a>
    <div class="clearfix"></div>
    </div>
    ...
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-15 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Appkit</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    ...
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-16 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">DuoDrawer</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    ...
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-17 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">EazyMobile</h5>
    </div>
    <div class="card-overlay bg-gradient"></div>
    ...
    </div><div class="splide__slide px-3" id="double-slider-3-slide01" style="width: 209px;" aria-hidden="true" tabindex="-1">
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-14 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Sticky Mobile</h5>
    ...
    <div class="splide__slide px-3" id="double-slider-3-slide02" style="width: 209px;" aria-hidden="true" tabindex="-1">
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-15 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">Appkit</h5>
    ...
    <div class="splide__slide px-3 is-active is-visible" id="double-slider-3-slide03" style="width: 209px;" aria-hidden="false" tabindex="0">
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-16 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">DuoDrawer</h5>
    ...
    <div class="splide__slide px-3 is-visible" id="double-slider-3-slide04" style="width: 209px;" aria-hidden="false" tabindex="0">
    <div class="item bg-theme pb-3 rounded-m shadow-l">
    <div data-card-height="200" class="card mb-3 bg-17 rounded-m" style="height: 200px;">
    <div class="card-bottom">
    <h5 class="color-white text-center pe-2 pb-2">EazyMobile</h5>
    ...
    <h1 class="font-24 font-700 color-green-dark">$0<sup class="font-15 opacity-50">.00</sup></h1>
    </div>
    <div class="ms-auto">
    ...
    <div class="divider mb-4"></div>
    <a href="#" class="btn btn-full btn-m bg-highlight font-700 text-uppercase rounded-sm"> Add to Cart</a>
    </div>
    </div>
    </div>
    <div class="card-overlay bg-highlight opacity-95"></div>
    ...
    <div class="content mb-3">
    <h5 class="float-start font-16 font-500">Browse Our Categories</h5>
    <a class="float-end font-12 color-highlight mt-n1" href="#">View All</a>
    <div class="clearfix"></div>
    </div>
    <a href="#" data-card-height="80" class="card card-style mb-3" style="height: 80px;">
    <div class="card-center">
    <h5 class="ps-3">Mobile PWA's</h5>
    <p class="ps-3 mt-n2 font-12 color-highlight mb-0">Focus on your Projects</p>
    </div>
    ...
    <a href="#" data-card-height="80" class="card card-style mb-3" style="height: 80px;">
    <div class="card-center">
    <h5 class="ps-3">Site Templates</h5>
    <p class="ps-3 mt-n2 font-12 color-highlight mb-0">Focus on your Projects</p>
    </div>
    <div class="card-center opacity-30">
    <i class="fa fa-arrow-right opacity-50 float-end color-theme pe-3"></i>
