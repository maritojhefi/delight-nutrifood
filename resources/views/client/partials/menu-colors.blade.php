...
<div class="card header-card color-card shape-rounded" style="height:40%">
    ...
    <a href="#" data-change-highlight="red" class="highlight-active"><i class="fa fa-circle color-red-dark"></i><span class="color-red-light">Red</span></a>
    ...
    <a href="#" class="close-menu btn btn-full btn-margins rounded-sm shadow-l bg-highlight btn-m font-900 text-uppercase mb-0" style="">Close color Menu</a>
