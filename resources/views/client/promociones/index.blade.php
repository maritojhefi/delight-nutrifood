...
<x-cabecera-pagina titulo="Promociones" cabecera="bordeado"/>
    ...
    <div class="card card-style me-0" data-card-height="380" style="background-image: url(&quot;images/grocery/4.jpg&quot;); height: 380px;">
    <div class="card-top">
    <a href="#" class="bg-theme color-theme rounded-sm icon icon-xs m-3"><i class="far fa-shopping-bag font-12"></i></a>
    </div>
    <div class="card-bottom bg-white m-2 p-3 rounded-s">
    <span class="badge bg-red-dark d-inline-block mb-2 text-uppercase font-11 mt-n2">35% Off</span>
    <h5 class="font-500 pt-2">
    Red Valley Cucumbers
    </h5>
    <div class="clearfix"></div>
    <span class="font-18 font-800 color-theme pt-2 d-block">$3.35</span>
    </div>
    </div>
    </div>
    <div class="col-6 ps-0">
    <div class="card card-style bg-20 mb-2" data-card-height="185" style="background-image: url(&quot;images/grocery/5.jpg&quot;); height: 185px;">
    <div class="card-top">
    <a href="#" class="bg-theme color-theme rounded-sm icon icon-xs m-3"><i class="far fa-shopping-bag font-12"></i></a>
    </div>
    <div class="card-bottom bg-white m-2 p-3 rounded-s">
    ...
    <div class="clearfix"></div>
    <span class="font-18 font-800 color-theme pt-0 d-block">$3.35</span>
    </div>
    </div>
    <div class="card card-style bg-14 mb-2" data-card-height="185" style="background-image: url(&quot;images/grocery/6.jpg&quot;); height: 185px;">
    <div class="card-top">
    <a href="#" class="bg-theme color-theme rounded-sm icon icon-xs m-3"><i class="far fa-shopping-bag font-12"></i></a>
    </div>
    <div class="card-bottom bg-white m-2 p-3 rounded-s">
    ...
    <div class="card card-style" data-card-height="330" style="background-image: url(&quot;images/grocery/8.jpg&quot;); height: 330px;">
    <div class="card-top">
    <a href="#" class="icon icon-m bg-white color-black rounded-sm m-3"><i class="fa fa-shopping-bag"></i></a>
    </div>
    <div class="card-top">
    <span class="badge bg-white px-2 py-2 color-black m-3 float-end"><i class="fa fa-star pe-2"></i>RECOMMENDED FOR YOU</span>
    </div>
    <div class="card-bottom bg-white m-2 p-3 rounded-s">
    <h4 class="font-500 font-16">
    Locally grown Blackberries.
    </h4>
    <p class="mb-0">
    Grown with great care on our local fields by expert handlers to create a perfect taste.
    </p>
    </div>
    </div>
