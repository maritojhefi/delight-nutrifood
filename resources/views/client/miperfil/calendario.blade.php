                ...
                <div class="p-2">
                    ...
                    <ul class="icon-list">
                        ...
                        <li><i class="fa fa-check color-green-dark"></i>{{ $plato }} :
                            <label for="" class="font-700 mb-0">{{ $valor }}</label>
                        </li>
                        @endif
                        @endforeach
                    </ul>
...
<script>
    $(document).ready(function () {
        ...
        $('input[type="radio"]').change(function() {
            ...
            $('.fac-radio[data-group="' + groupName + '"]').removeClass('font-700'); // Elimina la clase solo del grupo específico
            if ($(this).prop('checked')) {
                $(this).closest('.fac-radio').addClass('font-700'); // Agrega la clase al div padre más cercano
            }
        });
