...
<div class="card card-style">
    ...
    <div class="card card-style">
        <div class="list-group list-custom-small list-icon-0 bg-{{$lista['detalle']==null?'mint':'green'}}-dark ps-3 pe-4 ">
            <a data-bs-toggle="collapse" class="no-effect collapsed" href="#collapse-7{{$lista['id']}}" aria-expanded="false">
        ...
        <div class="ps-2 pe-4 collapse" id="collapse-7{{$lista['id']}}" data-bs-parent="#accordion-3" style="">
            <div class="p-2">
                ...
                <form action="{{route('personalizardia')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box1-fac-radio{{$lista['id']}}" type="radio" name="plato{{$lista['id']}}"
                                    value="{{$lista['ejecutivo']}}">
                                <label for="box1-fac-radio{{$lista['id']}}">{{$lista['ejecutivo']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box2-fac-radio{{$lista['id']}}" type="radio" name="plato{{$lista['id']}}"
                                    value="{{$lista['dieta']}}">
                                <label for="box2-fac-radio{{$lista['id']}}">{{$lista['dieta']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box3-fac-radio{{$lista['id']}}" type="radio" name="plato{{$lista['id']}}"
                        ...
                        <div class="col-6">
                            <mark class="highlight ps-2 font-12 pe-2 bg-blue-dark">Elija su carbohidrato</mark>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box4-fac-radio{{$lista['id']}}" type="radio" name="carb{{$lista['id']}}"
                                    value="{{$lista['carbohidrato_1']}}">
                                <label for="box4-fac-radio{{$lista['id']}}">{{$lista['carbohidrato_1']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box5-fac-radio{{$lista['id']}}" type="radio" name="carb{{$lista['id']}}"
                                    value="{{$lista['carbohidrato_2']}}">
                                <label for="box5-fac-radio{{$lista['id']}}">{{$lista['carbohidrato_2']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box6-fac-radio{{$lista['id']}}" type="radio" name="carb{{$lista['id']}}"
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box7-fac-radio{{$lista['id']}}" type="radio" name="envio{{$lista['id']}}"
                                    value="{{$lista['envio1']}}">
                                <label for="box7-fac-radio{{$lista['id']}}">{{$lista['envio1']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box8-fac-radio{{$lista['id']}}" type="radio" name="envio{{$lista['id']}}"
                                    value="{{$lista['envio2']}}">
                                <label for="box8-fac-radio{{$lista['id']}}">{{$lista['envio2']}}</label>
                            </div>
                            <div class="fac fac-radio fac-default"><span></span>
                                <input id="box9-fac-radio{{$lista['id']}}" type="radio" name="envio{{$lista['id']}}"
                                    value="{{$lista['envio3']}}">
                ...
                <ul class="icon-list">
                    ...
                    <li><i class="fa fa-check color-yellow-dark"></i>{{$plato}} : <label for=""
...
<div class="card card-style bg-18" data-card-height="150" style="height: 150px;">
    <div class="card-center ms-3">
        ...
        <p class="color-white mt-n1 mb-0 opacity-70">Es deber del cliente personalizar cada dia de su plan vigente para
            realizar una correcta entrega del pedido.</p>
    </div>
