...
<body id="margen" class="theme-light">
    ...
    <div id="toast-carrito" class="toast toast-tiny toast-top bg-green-dark hide" data-bs-delay="1000"
        ...
        <div id="saved-to-favorites" class="snackbar-toast bg-green-dark color-white fade hide" data-delay="3000" data-autohide="true"><i class="fa fa-heart me-3"></i>Añadido al carrito!</div>
