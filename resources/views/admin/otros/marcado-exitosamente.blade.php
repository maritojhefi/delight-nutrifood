...
@section('content')
<x-cabecera-pagina titulo="Listo...!" cabecera="bordeado" />
    <div class="card card-style text-center">
        <div class="content py-5">
            ...
            <h4 class="text-uppercase pb-3">Acabas de marcar tu entrada!</h4>
            <p class="boxed-text-l">
                 Tu hora de entrada es a las {{date('h:i')}} <br>
            ...
            <div class="row m-3>
                ...
                <div class="ms-3 me-3 alert alert-small rounded-s shadow-xl bg-yellow-dark" role="alert">
                    ...
                    <strong>Tienes un retraso de {{$diferencia}} minutos!</strong>
                    
                </div>
                @else
                <div class="ms-3 me-3 alert alert-small rounded-s shadow-xl bg-green-dark" role="alert">
                    <span><i class="fa fa-check"></i></span>
                    <strong>Me gusta tu puntualidad! Viniste {{$diferencia}} minutos antes</strong>
