            ...
            <div class="collapse navbar-collapse justify-content-between row">
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <a href="{{route('producto.listar')}}" class="btn  btn-sm light btn-outline-secondary">Productos <i class="fa fa-link"></i></a>
                        </div>
                        <div class="col-3">
                            <a href="{{route('almuerzos.reporte')}}" class="btn  btn-sm  btn-outline-info">Almuerzos <i class="fa fa-list"></i></a>
                        </div>
                        <div class="col-3">
                            <a href="{{route('usuario.listar')}}" class="btn  btn-sm  btn-outline-warning">Usuarios <i class="fa fa-user"></i></a>
                        </div>
                    </div>
                </div>
