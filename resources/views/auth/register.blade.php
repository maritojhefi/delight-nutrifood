                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                placeholder="Nombre Completo" name="name" value="{{ old('name') }}" required>
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field">
                            <i class="fa fa-at"></i>
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="form1a"
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field">
                            ...
                            <input type="number" class="form-control @error('telefono') is-invalid @enderror"
                                id="telefono" placeholder="Telefono" name="telefono" value="{{ old('telefono') }}"
                                required>
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field">
                            ...
                            <input type="date" class="form-control @error('fecha') is-invalid @enderror" id="fecha"
                                placeholder="Nacimiento" name="fecha" value="{{ old('fecha') }}" required>
                        ...
                        @error('fecha')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                        <div class="input-style input-transparent no-borders has-icon validate-field row">
                            <input type="text" class="form-control col-4" id="dd" maxlength=2
                                onkeyup="moveToNext(this,'mm')" />
                            <input type="text" class="form-control col-4" id="mm" maxlength=2
                                onkeyup="moveToNext(this,'yyyy')" />
                            <input type="text" class="form-control col-4" id="yyyy" maxlength=4 />
                        </div>
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field">
                            ...
                            <input type="text" class="form-control @error('direccion') is-invalid @enderror"
                                id="direccion" placeholder="Direccion detallada" name="direccion"
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field mt-4">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                id="form3a" placeholder="Contraseña" required name="password">
                        ...
                        <div class="input-style input-transparent no-borders has-icon validate-field mt-4">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                id="asd" placeholder="Confirmar" name="password_confirmation">
                        ...
                        <div class="row">
                            <div class="col-12 pt-3 text-end"><a href="{{ route('login') }}"
                                    class="color-white opacity-50 font-15">Ya tienes una cuenta? <strong>Inicia
                                        Sesion</strong>
                                </a></div>
                        </div>
                    </form>
