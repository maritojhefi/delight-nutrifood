...
class CarritoController extends Controller
{
    ...
    /**
     * Validar multiples elementos del carrito
     */
    ...
    /**
     * Procesar multiples items del carrito
     */
    ...
    /**
     * Procesar un unico item del carrito
     */
    private function processIndividualItem($producto, array $itemData, int $sucursaleId): array
    {
        ...
        $estado = $this->determinarEstado($stockDisponible, $cantidadSolicitada, $adicionalesLimitados);
    ...
    /**
     * Procesar los adicionales para un elemento del carrito
     */
    ...
    /**
     * Construir respuesta de validacion
     */
    ...
    protected function determinarEstado($stockDisponible, $cantidadSolicitada, bool $adicionalesLimitados = false)
    {
