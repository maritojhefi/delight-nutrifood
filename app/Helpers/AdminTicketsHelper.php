        ...
        if ($numero != '0') {
            ...
            switch ($paso) {
                case '1':
                    ...
                    AdminTicketsHelper::enviarMensajeConMenu($usuario, $paso, $menuDiaActual,$fechaPlan,$array);
                    break;
                case '2':
                    if ($numero == "1") {
                ...
                case '3':
                    ...
                    if ($array->ENVIO != Plane::ENVIO1) {
                        ...
                        AdminTicketsHelper::enviarMensajeConMenu($usuario, '4', $menuDiaActual,$fechaPlan,$array);
